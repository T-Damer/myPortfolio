          ...
          <div className="glassWrapper flex-col justify-start space-y-6">
            ...
            <Card>
              <div>
                ...
                <p className="text-white py-2">
                  <span className="text-white font-bold">Problem: </span> We
                  have many databases, I decided to test firebase with Redux,
                  also connected TypeScript
                </p>
                <p className="text-white py-2">
                  <span className="text-white font-bold">Solution: </span> A
                  good decision was to use TypeScript, it really facilitated the
                  task. Redux is pretty flexible, so I choose it instead of
                  mobx, also it's really good to use with firebase, because we
                  have packages that make the task easier
                </p>
                <p className="text-white py-2">
                  <span className="text-white font-bold">Reason: </span> As we
                  know, we can host our web-site using firebase, also it's
                  really friendly to new developers, we can set rules and create
            ...
            <Card>
              <div>
                ...
                <p className="text-white py-2">
                  ...
                  opinion QtDesigner is one of the simplest way to create GUI
                  for windows. It is not crossplatform, but suitable for
                  training. To load youtube video we will use special library
                  for python.
                </p>
                <p className="text-white py-2">
                  <span className="text-white font-bold">Reason: </span> As we
            ...
            <Card>
              <div>
                ...
                <p className="text-white py-2">
                  <span className="text-white font-bold">Problem: </span> We
                  have many web-site builders, but usually they're not-free and
                  very limited in functions. I needed a portfolio for all my
                  work.
                </p>
                <p className="text-white py-2">
                  <span className="text-white font-bold">Solution: </span> I
                  decided to build web-site using react.js and tailwind, then
                  host it. I found good template, we have many things
                  preconfigured here. TypeScript included because project may
                  scale and I don't want to cath bugs like wrong import `{`App`}
                  `
                </p>
                <p className="text-white py-2">
                  <span className="text-white font-bold">Reason: </span> As we
                  know, react.js is popular because of reactive components. We
                  can create something and reuse it without copying code, live
