        ...
        <div className="glassWrapper flex-col md:flex-row">
          ...
          <div className="flex-column items-start">
            ...
            <p className="text-white">
              ...
              forums and hosted the online event page. Soon I realized, that
              this is not enough to make a meaningful contribution to life, so I
              began to <span className="text-yellow-300">code</span>.
            </p>
          </div>
        </div>
